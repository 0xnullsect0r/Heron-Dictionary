// Theme catalogue ported from DelphiNet6.
// Built-in themes are switched via data-theme on <html>.
// Custom themes write CSS vars directly to documentElement.style.

export const THEME_TOKEN_KEYS = [
  'bgBase', 'bgSurface', 'bgElevated', 'bgHover',
  'border', 'brand', 'brandHover', 'brandMuted',
...
export const TOKEN_LABELS: Record<ThemeTokenKey, string> = {
  bgBase: 'Background', bgSurface: 'Surface', bgElevated: 'Elevated', bgHover: 'Hover',
  border: 'Border', brand: 'Brand', brandHover: 'Brand hover', brandMuted: 'Brand muted',
  textPrimary: 'Text', textSecondary: 'Subtle text', textDisabled: 'Disabled text',
  danger: 'Danger', warning: 'Warning', success: 'Success',
};

const tokenToCssVar: Record<ThemeTokenKey, string> = {
  bgBase: '--color-bg-base', bgSurface: '--color-bg-surface',
  bgElevated: '--color-bg-elevated', bgHover: '--color-bg-hover',
  border: '--color-border', brand: '--color-brand',
  brandHover: '--color-brand-hover', brandMuted: '--color-brand-muted',
  textPrimary: '--color-text-primary', textSecondary: '--color-text-secondary',
  textDisabled: '--color-text-disabled', danger: '--color-danger',
...
export const BUILT_IN_THEMES: ThemeDefinition[] = [
  {
    key: 'delphinet', name: 'Delphinet (Default)', isDark: true,
    tokens: {
      bgBase: '#0B0F0D', bgSurface: '#111713', bgElevated: '#1A2119', bgHover: '#1F2A1E',
      border: '#2A3828', brand: '#016745', brandHover: '#017d53', brandMuted: '#013d28',
      textPrimary: '#E8F5E0', textSecondary: '#8FAF87', textDisabled: '#4A6548',
      danger: '#e53e3e', warning: '#d97706', success: '#16a34a',
    },
  },
  {
    key: 'midnight', name: 'Midnight', isDark: true,
    tokens: {
  ...
  {
    key: 'nord', name: 'Nord', isDark: true,
    tokens: {
  ...
  {
    key: 'solarized-dark', name: 'Solarized Dark', isDark: true,
    tokens: {
  ...
  {
    key: 'solarized-light', name: 'Solarized Light', isDark: false,
    tokens: {
  ...
  {
    key: 'synthwave', name: 'Synthwave', isDark: true,
    tokens: {
  ...
  {
    key: 'gruvbox', name: 'Gruvbox', isDark: true,
    tokens: {
